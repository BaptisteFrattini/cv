...
"Dessin scientifique en biologie marine", MNHN, Station marine de Concarneau  \newline
"Porifera taxonomic workshop - DeepSeaTax", ISYEB, MNHN Paris  \newline
"Bonnes pratiques pour une recherche reproductible en écologie numérique", CESAB, FRB Montpellier  
\end{adjustwidth}
...
\begin{adjustwidth}{2em}{0pt}
UE Embryologie : Scéances de travaux pratiques de 4h - Dissection d'un oeuf de poule

UE Ecologie et Environnement : Travaux dirigés de 2h - Création d'un poster scientifique, Jeux serieux sur les enjeux environnementaux de l'île de La Réunion

Surveillance d'examens et corrections de copies
\end{adjustwidth}

`2021-2022`
**Enseignant contractuel**, Contrat de 16h d’enseignement d'SVT par semaine en classes de 1ère et Terminale, Lycée Felix Le Dantec, Lannion
...
Participation en tant que jury aux oraux de stage
\end{adjustwidth}
